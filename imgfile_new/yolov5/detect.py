...
@torch.no_grad()
def run(weights='yolov5/weights/last.pt',  # model.pt path(s)
        source='img.jpg',  # file/dir/URL/glob, 0 for webcam
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov5/weights/last.pt', help='model.pt path(s)')
